...
\subsection{Método de Euler para sistemas de ecuaciones (Ejercicio teórico-práctico 2)}
...
\subsection{Influencia de los errores de truncatura}

Vamos a mostrar ahora la influencia que tienen los errores de truncatura cuando se usan métodos numéricos para resolver ecuaciones diferenciales. Para ejemplificar este hecho, vamos a partir del problema de valores iniciales anterior, y vamos a calcular la aproximación obtenida con el método de Euler para distintos tamaños de paso.\\
